...
export default function RecipesClientSection({ initialRecipes }: Props) {
  ...
  // Escuta atualizações em tempo real do admin e re-busca silenciosamente.
  // AbortController cancela o fetch anterior se uma nova mensagem chegar antes
  // de ele terminar, evitando race condition com respostas fora de ordem.
  useEffect(() => {
